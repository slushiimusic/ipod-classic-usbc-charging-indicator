...
OS_SECTORS = {0, 0x800, 0xfe000, 0x18a800, 0x1ae000, 0x1d8800, 0x1d9000, 0x202000, 0x202800, 0x203000, 0x735800}
...
def manifests(root=None):
    ...
    for name, expected in [('v2', V2), ('v3', V3), ('responsive', RESPONSIVE), ('smooth', SMOOTH),
                           ('v4', V4), ('smooth_v2', SMOOTH_V2), ('fast', FAST)]:
...
def plan_for(prefix, mode='install', patch_set=None):
    require(mode in ('install', 'responsive', 'smooth', 'fast', 'restore', 'inspect'), 'Invalid operation')
    ...
    require(observed in (STOCK, V2, V3, RESPONSIVE, SMOOTH, V4, SMOOTH_V2, FAST),
    ...
    target = {'responsive': RESPONSIVE, 'smooth': SMOOTH_V2, 'fast': FAST}.get(mode, V4)
