...
FAST = '13532f5f4312e630384eac74e9a7d17c64d42cf69093f4fe0321d64b7fb8681b'
...
EFFICIENT_V5 = '20b25c2436ebb1df79a2e5150a816c17c1c7482d59850316565007a8e0df1470'
...
OS_SECTORS = {0, 0x800, 0xfe000, 0x11d800, 0x121000, 0x18a800, 0x1ae000, 0x1d8800, 0x1d9000, 0x202000, 0x202800, 0x203000, 0x735800}
...
def manifests(root=None):
    ...
    for name, expected in [('v2', V2), ('v3', V3), ('responsive', RESPONSIVE), ('smooth', SMOOTH),
                           ('v4', V4), ('smooth_v2', SMOOTH_V2), ('fast', FAST), ('efficient', EFFICIENT), ('efficient_v2', EFFICIENT_V2), ('efficient_v3', EFFICIENT_V3), ('efficient_v4', EFFICIENT_V4), ('efficient_v5', EFFICIENT_V5)]:
...
def plan_for(prefix, mode='install', patch_set=None):
    require(mode in ('install', 'responsive', 'smooth', 'fast', 'efficient', 'drawing_previous', 'restore', 'inspect'), 'Invalid operation')
    ...
    require(observed in (STOCK, V2, V3, RESPONSIVE, SMOOTH, V4, SMOOTH_V2, FAST, EFFICIENT, EFFICIENT_V2, EFFICIENT_V3, EFFICIENT_V4, EFFICIENT_V5),
    ...
    target = {'responsive': RESPONSIVE, 'smooth': SMOOTH_V2, 'fast': FAST, 'efficient': EFFICIENT_V5, 'drawing_previous': EFFICIENT_V4}.get(mode, V4)
    ...
    require(len(plan) <= 12, 'Too many firmware sectors')
