...
from check_single_paint import CANDIDATE
...
for start,end in [(0x11db68,0x11db6c),(0x11dc10,0x11dc14),(0x735e54,0x735f10)]:copy_only[start:end]=candidate[start:end]
